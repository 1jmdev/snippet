...
export const languages: LanguageConfig[] = [
    ...
    },
    {
        ...
        name: "SCSS",
        extensions: [".scss"],
        patterns: [/\$\w+\s*:/, /@mixin\s+\w+/, /@include\s+\w+/, /&:\w+/],
    },
    {
        id: "json",
        name: "JSON",
    ...
    },
    {
        ...
        name: "YAML",
        extensions: [".yaml", ".yml"],
        patterns: [/^\w+:\s*$/m, /^\s+-\s+\w+/m, /^\w+:\s+\w+/m],
    },
    {
        id: "markdown",
        name: "Markdown",
    ...
    },
    {
        ...
        name: "PowerShell",
        extensions: [".ps1"],
        patterns: [/\$\w+\s*=/, /Write-Host/, /Get-\w+/, /Set-\w+/],
    },
    {
        id: "dockerfile",
        name: "Dockerfile",
        extensions: ["Dockerfile"],
        patterns: [/^FROM\s+\w+/m, /^RUN\s+/m, /^COPY\s+/m, /^CMD\s+/m],
    },
    {
        id: "graphql",
        name: "GraphQL",
        extensions: [".graphql", ".gql"],
        patterns: [/^(query|mutation|subscription)\s+\w+/m, /^type\s+\w+\s*{/m],
    },
    {
        id: "vue",
        name: "Vue",
